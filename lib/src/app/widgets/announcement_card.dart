...
const sampleAnnouncements = [
  Announcement(
    ...
    preview: 'Список дисциплин обновлён — добавлено 8 новых курсов по направлениям ИИ и Data Science.',
  ...
  Announcement(
    ...
    preview: 'Добавлено 12 новых тем по направлениям NLP и компьютерное зрение от четырёх преподавателей.',
    body: 'Уважаемые студенты 4-го курса!\n\n'
  ...
  Announcement(
    ...
    preview: 'Пары 12–13 мая переносятся для студентов, участвующих в научной конференции.',
    body: 'Уважаемые студенты!\n\n'
