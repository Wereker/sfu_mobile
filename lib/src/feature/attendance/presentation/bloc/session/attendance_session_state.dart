...
class AttendanceSessionState with _$AttendanceSessionState {
  ...
  const factory AttendanceSessionState.sessionReady(AttendanceSession session)      = _SessionReady;
  const factory AttendanceSessionState.studentsLoading()                            = _StudentsLoading;
  const factory AttendanceSessionState.studentsSuccess(List<AttendanceStudent> students) = _StudentsSuccess;
