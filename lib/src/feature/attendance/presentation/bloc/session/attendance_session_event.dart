...
class AttendanceSessionEvent with _$AttendanceSessionEvent {
  ...
  const factory AttendanceSessionEvent.closeSession(String sessionId) = _CloseSession;

  const factory AttendanceSessionEvent.loadStudents(String sessionId) = _LoadStudents;
